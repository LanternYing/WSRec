...
CloudPred/
  ...
  - src/                    - directory of the source files
      ...
      - predict.py          - control execution and results collection of the 
                              specific algorithm
      - CloudPred.so        - the external module built from C++ 
                              implementations from "CloudPred_core/"
      - CloudPred_core/     - directory of c++ implementation of CloudPred
          - UIPCC_core.h    - header file of UIPCC
          - UIPCC_core.cpp  - source file of UIPCC
		  - NMF_core.h      - header file of NMF
          - NMF_core.cpp    - source file of NMF
          - CloudPred.pyx   - a python wrapper written in Cython for C++ 
                              functions 
          - CloudPred.cpp   - This file is automatically generated by Cython 
                              for building CloudPred.so
...
Make sure the external module "CloudPred.so" exists. If not, you can build it 
