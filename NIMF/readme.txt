----------------------------------------------------------------------------
README file for NIMF
----------------------------------------------------------------------------

Author: Jamie Zhu <jimzhu@GitHub>
Last updated: 2014/5/9.

This package implements a benchmark approach, NIMF (Zheng et al., TSC'13), 
...
NIMF/
  ...
  - src/                    - directory of the source files
      ...
      - execute.py          - control execution and results collection of the 
                              specific algorithm
      - NIMF.so             - the external module built from C++ 
                              implementations from "NIMF_core/"
      - NIMF_core/          - directory of c++ implementation of NIMF
          - NIMF_core.h     - header file of NIMF
          - NIMF_core.cpp   - source file of NIMF
          - UIPCC_core.h    - header file of UIPCC
          - UIPCC_core.cpp  - source file of UIPCC
          - NIMF.pyx        - a python wrapper written in Cython for C++ 
                              functions 
          - NIMF.cpp        - This file is automatically generated by Cython 
                              for building NIMF.so
...
Make sure the external module "NIMF.so" exists. If not, you can build it by 
