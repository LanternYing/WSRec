...
GreedyRank/
  ...
  - src/                    - directory of the source files
      ...
      - core/               - directory of c++ implementation 
          - GreedyRank.h    - header file
          - GreedyRank.cpp  - source file
...
detailed experimental results with six evaluation metrics (e.g., NDCG10), 
under the "result/" directory, after running the above QoS ranking prediction 
approach on "data/dataset#1". E.g.,"result/rtResult_0.05.txt" records the 
