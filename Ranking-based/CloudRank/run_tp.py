...
if not os.path.isfile('src/CloudRank.so'):
	print 'Lack of CloudRank.so (the built C++ module of core CloudRank).'
	print 'Please first build the C++ code into CloudRank.so by using: '
