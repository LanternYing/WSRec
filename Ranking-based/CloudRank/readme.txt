----------------------------------------------------------------------------
README file for CloudRank
----------------------------------------------------------------------------

Author: Jamie Zhu <jimzhu@GitHub>
Last updated: 2014/6/18.

This package implements a benchmark approach, CloudRank (Zheng et al., 
...
LoRec/
  ...
  - src/                        - directory of the source files
      ...
      - CloudRank.so            - the external module built from C++ 
                                  implementations from "CloudRank_core/"
      - CloudRank_core/         - directory of c++ implementation of CloudRank
          - CloudRank_core.h    - header file
          - CloudRank_core.cpp  - source file
          - CloudRank.pyx       - a python wrapper written in Cython for C++ 
                                  functions 
          - CloudRank.cpp       - This file is automatically generated by Cython 
                                  for building CloudRank.so
...
Make sure the external module "CloudRank.so" exists. If not, you can build it 
