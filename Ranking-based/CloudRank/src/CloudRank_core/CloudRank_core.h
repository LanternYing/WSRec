/********************************************************
 * CloudRank_core.h: header file of CloudRank_core.cpp
...
/* Perform the core approach of CloudRank */
void CloudRank_core(double *removedData, int numUser, int numService, int topK, int *predData);
