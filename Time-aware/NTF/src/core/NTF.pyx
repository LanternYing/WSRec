...
#
cdef extern from "NTF_core.h":
    void NTF_core(double *removedData, double *predData, int numUser, 
...
#
def predict(removedTensor, paraStruct):
    ...
    cdef bool debugMode = paraStruct['debugMode']
