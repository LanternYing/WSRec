...
This package implements a benchmark approach, EMF (Lo et al., 
SCC'12), for Web service QoS prediction. 
...
EMF/
  ...
  - src/                    - directory of the source files
      ...
      - predict.py          - control execution and results collection of the 
                              specific algorithm
      - EMF.so              - the external module built from C++ 
                              implementations from "EMF_core/"
      - EMF_core/           - directory of c++ implementation of EMF
          - EMF_core.h      - header file of EMF
          - EMF_core.cpp    - source file of EMF
          - UIPCC_core.h    - header file of UIPCC
          - UIPCC_core.cpp  - source file of UIPCC
          - EMF.pyx         - a python wrapper written in Cython for C++ 
                              functions 
          - EMF.cpp         - This file is automatically generated by Cython 
                              for building EMF.so
...
Make sure the external module "EMF.so" exists. If not, you can build it by 
