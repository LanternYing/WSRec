----------------------------------------------------------------------------
README file for RegionKNN
----------------------------------------------------------------------------

Author: Jamie Zhu <jimzhu@GitHub>
Last updated: 2014/5/25.

This package implements a benchmark approach, RegionKNN (Chen et al., ICWS'2010), 
...
RegionKNN/
  ...
  - src/                        - directory of the source files
      ...
      - execute.py              - control execution and results collection of the 
                                  specific algorithm
      - RegionKNN.so            - the external module built from C++ 
                                  implementations from "RegionKNN_core/"
      - RegionKNN_core/         - directory of c++ implementation of RegionKNN
          - RegionKNN_core.h    - header file
          - RegionKNN_core.cpp  - source file
          - RegionKNN.pyx       - a python wrapper written in Cython for C++ 
                                  functions 
          - RegionKNN.cpp       - This file is automatically generated by Cython 
                                  for building RegionKNN.so
...
Make sure the external module "RegionKNN.so" exists. If not, you can build it by 
...
- Xi Chen, Xudong Liu, Zicheng Huang, and Hailong Sun, "RegionKNN: A Scalable 
  Hybrid Collaborative Filtering Algorithm for Personalized Web Service 
  Recommendation," in Proc. of IEEE International Conference on Web Services 
  (ICWS), 2010, pp. 9-16.
