----------------------------------------------------------------------------
README file for LoRec
----------------------------------------------------------------------------

Author: Jamie Zhu <jimzhu@GitHub>
Last updated: 2014/5/25.

This package implements a benchmark approach, LoRec (Chen et al., TPDS'2014), 
...
LoRec/
  ...
  - src/                    - directory of the source files
      ...
      - execute.py          - control execution and results collection of the 
                              specific algorithm
      - LoRec.so            - the external module built from C++ 
                              implementations from "LoRec_core/"
      - LoRec_core/         - directory of c++ implementation of LoRec
          - LoRec_core.h    - header file
          - LoRec_core.cpp  - source file
          - LoRec.pyx       - a python wrapper written in Cython for C++ 
                              functions 
          - LoRec.cpp       - This file is automatically generated by Cython 
                              for building LoRec.so
...
Make sure the external module "LoRec.so" exists. If not, you can build it by 
...
- Xi Chen, Zibin Zheng, Qi Yu, and Michael R. Lyu, "Web Service Recommendation 
  via Exploiting Location and QoS Information," IEEE Transactions on Parallel 
  and Distributed Systems (TPDS), preprint, 2014.
