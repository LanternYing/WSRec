...
This package implements a benchmark approach, HMF (He et al., ICWS'14), for 
...
HMF/
  ...
  - src/                    - directory of the source files
      ...
      - execute.py          - control execution and results collection of the 
                              specific algorithm
      - HMF.so              - the external module built from C++ 
                              implementations from "HMF_core/"
      - HMF_core/           - directory of c++ implementation of HMF
          - HMF_core.h      - header file
          - HMF_core.cpp    - source file
          - HMF.pyx         - a python wrapper written in Cython for C++ 
                              functions 
          - HMF.cpp         - This file is automatically generated by Cython 
                              for building HMF.so
...
Make sure the external module "HMF.so" exists. If not, you can build it by 
...
- Pinjia He, Jieming Zhu, Zibin Zheng, Jianlong Xu, and M.R. Lyu, "Location-
  based Hierarchical Matrix Factorization for Web Service Recommendation," in 
  Proc. of the 21st International Conference on Web Services (ICWS'14), 2014. 
