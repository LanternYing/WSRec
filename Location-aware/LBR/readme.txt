...
LBR/
  ...
  - src/                    - directory of the source files
      ...
      - predict.py          - control execution and results collection of the 
                              specific algorithm
      - LBR.so              - the external module built from C++ 
                              implementations from "LBR_core/"
      - LBR_core/           - directory of c++ implementation of LBR
          - LBR_core.h      - header file
          - LBR_core.cpp    - source file
          - LBR.pyx         - a python wrapper written in Cython for C++ 
                              functions 
          - LBR.cpp         - This file is automatically generated by Cython 
                              for building LBR.so
...
Make sure the external module "LBR.so" exists. If not, you can build it by 
